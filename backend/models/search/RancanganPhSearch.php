...
/**
 * RancanganPhSearch represents the model behind the search form of `backend\models\RancanganPh`.
 */
class RancanganPhSearch extends RancanganPh
{
    /**
     * {@inheritdoc}
     */
